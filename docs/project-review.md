...
> **Status update (2026-09-23):** Items **C1–C3** and **H1–H6** in Part 4 are now fixed on `main`. See Milestone 7 in `roadmap.md`. The Medium, Low, and Part 5 items are still open.
